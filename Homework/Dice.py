#  File: Dice.py
#  Description: Simulate random rolls of two dice and display frequency of added values on a histogram
...
def countRolls(rolls):
	'''
	Count the number of each number rolled
	'''

	# initialize counts dictionary and give possible outcomes a count of 0
	counts = {}
	for i in range(2, 13):
		counts[i] = 0
